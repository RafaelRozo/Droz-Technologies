---
title: "Laser Shaft Alignment: Why Tolerances Matter More Than You Think"
...
> **Not sure if your coupling alignment is inside tolerance?** [Talk to an Engineer](/contact) — we bring calibrated laser systems to Ontario sites and document every alignment against ISO-level tolerances.
...
| Shaft Speed (RPM) | Angular Tolerance (Excellent) | Parallel Offset (Excellent) |
|-------------------|-------------------------------|-----------------------------|
| Up to 1,000       | 0.09 mm/100 mm                | 0.09 mm                     |
...
> **Running high-speed pumps or compressors?** [Talk to an Engineer](/contact) — if your alignment records show the same tolerance for 1,800 and 3,600 RPM machines, something is wrong.
...
This is the same discipline we apply in our broader predictive maintenance work. For the equipment side of the story — the tools and sensors that make this practical — see our [Canadian vibration equipment buyers guide](/blog/canadian-vibration-equipment-buyers-guide).
...
> **Ready to benchmark your fleet's alignment?** [Talk to an Engineer](/contact) — we will audit your top 10 critical machines and show you exactly where you are losing bearing life.
