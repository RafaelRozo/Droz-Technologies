...
export const metadata: Metadata = {
  ...
  description: "Predictive maintenance, custom software, and AI consulting. 3 divisions serving Ontario industry. Burlington, ON.",
  openGraph: {
    title: "Industrial Technology & AI Solutions | Droz Technologies — Ontario",
    description: "Predictive maintenance, custom software, and AI consulting for Ontario industry.",
